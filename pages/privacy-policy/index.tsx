import { fetchPrivacyPolicy } from "@/api/functions/cms.api";
...
export const getServerSideProps = async () => {
    ...
    const { data: privacy_policy } = await fetchPrivacyPolicy();
...
export default function Index({ privacy_policy }: privacyPageProps) {
    return (
        <Wrapper>
            <InnerBanner bannerText={privacy_policy.title} />
